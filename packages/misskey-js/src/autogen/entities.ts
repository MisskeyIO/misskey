...
export type UsersGetTwofactorEnableRequest = operations['users___get-twofactor-enable']['requestBody']['content']['application/json'];
export type UsersGetTwofactorEnableResponse = operations['users___get-twofactor-enable']['responses']['200']['content']['application/json'];
