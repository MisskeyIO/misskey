...
export const DI = {
	...
	singleSignOnServiceProvidersRepository: Symbol('singleSignOnServiceProvidersRepository'),
	...
	userAccountMoveLogsRepository: Symbol('userAccountMoveLogsRepository'),
