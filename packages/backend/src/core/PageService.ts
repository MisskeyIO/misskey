...
export class PageService {
	...
	public async create(
		...
		await this.pagesRepository.findBy({
			...
			if (result.length > 0) {
				throw new IdentifiableError('1a79e38e-3d83-4423-845b-a9d83ff93b61', 'Specified name already exists.');
			}
		});
	...
	public async update(
		...
		await this.db.transaction(async (transaction) => {
			...
			if (page == null) {
				throw new IdentifiableError('66aefd3c-fdb2-4a71-85ae-cc18bea85d3f', 'No such page.');
			}
			...
			if (body.name != null) {
				await transaction.findBy(MiPage, {
					...
					if (result.length > 0) {
						throw new IdentifiableError('d05bfe24-24b6-4ea2-a3ec-87cc9bf4daa4', 'Specified name already exists.');
					}
				});
			}
