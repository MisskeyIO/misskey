...
import { getBuiltinThemesRef, getThemesRef, installTheme, removeTheme } from '@/theme.js';
...
import { getPlainDragData, setPlainDragData } from '@/drag-and-drop.js';
...
const themesCount = computed(() => installedThemes.value.length);
