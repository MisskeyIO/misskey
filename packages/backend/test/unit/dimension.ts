...
describe('getDeliverTargetDimensions', () => {
	...
	test('note in dimension 1 replying to dimension 1000 (private) should deliver to dimension 0, 1, and 1000', () => {
		const result = getDeliverTargetDimensions(1, 1000);
