...
<script lang="ts">
import Vue from 'vue';
import { faAt, faListUl, faEye, faEyeSlash, faBan, faPencilAlt, faComments, faUsers, faExclamationCircle, faMicrophoneSlash } from '@fortawesome/free-solid-svg-icons';
