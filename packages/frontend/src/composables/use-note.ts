...
export function useNote(
	...
	const tl_dimension = options.tl_dimension ?? ref(null);
	...
	// ミュート判定
	const muted = ref(calculateMuteStatus(appearNote, $i, $i?.mutedWords ?? [], inTimeline && !tl_withSensitive.value));
