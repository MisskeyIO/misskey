	...
	<div ref="rootEl" :class="$style.root">
		...
		<div :class="$style.footer">
			<MkButton
				...
				gradate
				full
				:disabled="!hasReachedBottom || gotItDisabled"
				@click="gotIt"
			>
				{{ !hasReachedBottom ? i18n.ts.scrollToClose : (!announcement.needEnrollmentTutorialToRead ? i18n.ts.gotIt : i18n.ts._initialAccountSetting.startTutorial) }}
