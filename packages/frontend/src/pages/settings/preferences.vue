...
<template>
<SearchMarker
	path="/settings/preferences" :label="i18n.ts.preferences" :keywords="['general', 'preferences']"
						...
						<div class="_gaps_s">
							...
							<SearchMarker :keywords="['pinned', 'list']">
								<MkFolder>
									...
									<MkButton v-if="prefer.r.pinnedUserLists.value.length === 0" @click="setPinnedList()">
										{{
											i18n.ts.add
										}}
									</MkButton>
								...
								<SearchMarker :keywords="['renote', 'count', 'show']">
									<MkPreferenceContainer k="showRenotesCount">
										<MkSwitch v-model="showRenotesCount">
											<template #label>
												<SearchLabel>{{ i18n.ts.showRenotesCount }}</SearchLabel>
											</template>
										</MkSwitch>
									</MkPreferenceContainer>
								</SearchMarker>
							...
							<MkPreferenceContainer k="notificationPosition">
								<MkRadios v-model="notificationPosition">
									...
									<option value="leftBottom">
										<i class="ti ti-align-box-left-bottom"></i> {{ i18n.ts.leftBottom }}
									</option>
									<option value="rightBottom">
										<i class="ti ti-align-box-right-bottom"></i> {{ i18n.ts.rightBottom }}
									</option>
								</MkRadios>
							</MkPreferenceContainer>
						</SearchMarker>
							...
							<MkPreferenceContainer k="notificationStackAxis">
								<MkRadios v-model="notificationStackAxis">
									...
									<option value="horizontal">
										<i class="ti ti-carousel-horizontal"></i> {{ i18n.ts.horizontal }}
									</option>
								</MkRadios>
							</MkPreferenceContainer>
						</SearchMarker>
							...
							<SearchMarker :keywords="['follow', 'replies']">
								<MkPreferenceContainer k="defaultFollowWithReplies">
									<MkSwitch v-model="defaultFollowWithReplies">
										<template #label>
											<SearchLabel>{{ i18n.ts.withRepliesByDefaultForNewlyFollowed }}</SearchLabel>
										</template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>
							...
							<MkFolder>
								...
								<div class="_buttons">
									<template v-for="lang in emojiIndexLangs" :key="lang">
										<MkButton
											v-if="store.r.additionalUnicodeEmojiIndexes.value[lang]" danger
										...
										<MkButton v-else @click="downloadEmojiIndex(lang)">
											<i class="ti ti-download"></i> {{
												getEmojiIndexLangName(lang)
											}}{{ store.r.additionalUnicodeEmojiIndexes.value[lang] ? ` (${i18n.ts.installed})` : '' }}
										</MkButton>
									</template>
								</div>
							</MkFolder>
