	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		<SearchMarker path="/admin/settings" :label="i18n.ts.general" :keywords="['general', 'settings']" icon="ti ti-settings">
			<div class="_gaps_m">
				<SearchMarker v-slot="slotProps" :keywords="['information', 'meta']">
					<MkFolder :defaultOpen="true">
						...
						<div class="_gaps">
							...
							<SearchMarker :keywords="['featured', 'game', 'channels']">
								<MkTextarea v-model="infoForm.state.featuredGameChannels">
									<template #label><SearchLabel>{{ i18n.ts.featuredGameChannels }}</SearchLabel></template>
				...
				<SearchMarker v-slot="slotProps" :keywords="['dimension']">
					<MkFolder :defaultOpen="slotProps.isParentOfTarget">
						...
						<MkInput v-model="dimensionForm.state.dimensions" type="number" min="1" step="1">
							<template #label><SearchLabel>{{ i18n.ts._serverSettings.dimensions }}</SearchLabel><span v-if="dimensionForm.modifiedStates.dimensions" class="_modified">{{ i18n.ts.modified }}</span></template>
