...
FROM --platform=$BUILDPLATFORM node:26 AS native-builder
...
FROM --platform=$TARGETPLATFORM node:26 AS target-builder
...
FROM --platform=$TARGETPLATFORM node:26-slim AS runner
