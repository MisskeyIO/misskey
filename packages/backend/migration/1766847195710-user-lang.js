export class UserLangNoteLang1766847195710 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user_lang" ("userId" character varying(32) NOT NULL, "postingLang" character varying(32), "viewingLangs" character varying array NOT NULL DEFAULT '{}', "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_user_lang" PRIMARY KEY ("userId"))`);
