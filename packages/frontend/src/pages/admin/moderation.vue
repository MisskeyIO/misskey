	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		<SearchMarker path="/admin/moderation" :label="i18n.ts.moderation" :keywords="['moderation']" icon="ti ti-shield" :inlining="['serverRules']">
			<div class="_gaps_m">
				...
				<SearchMarker :keywords="['blocked', 'remote', 'custom', 'emojis']">
					<MkFolder>
						<template #icon><SearchIcon><i class="ti ti-mood-empty"></i></SearchIcon></template>
						<template #label><SearchLabel>{{ i18n.ts.blockedRemoteCustomEmojis }}</SearchLabel></template>
				...
				<SearchMarker :keywords="['url', 'site', 'preview']">
					<MkFolder>
