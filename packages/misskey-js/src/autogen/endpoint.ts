...
export type Endpoints = {
	...
	'admin/emoji/update': { req: AdminEmojiUpdateRequest; res: AdminEmojiUpdateResponse };
	...
	'notes/scheduled/create': { req: NotesScheduledCreateRequest; res: NotesScheduledCreateResponse };
