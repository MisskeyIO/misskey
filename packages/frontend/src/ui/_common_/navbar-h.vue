...
<div :class="[$style.root, acrylic ? $style.acrylic : null]">
	<div :class="$style.body">
		<div :class="$style.left">
			...
			<MkA v-if="$i && ($i.isAdmin || $i.isModerator)" v-click-anime v-tooltip="i18n.ts.controlPanel" :class="$style.item" activeClass="active" to="/admin" :behavior="settingsWindowed ? 'window' : null">
...
async function more(ev: MouseEvent) {
	...
	await os.popupAsyncWithDialog(import('@/components/MkLaunchPad.vue').then(x => x.default), {
